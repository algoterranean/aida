 ...
 * allowlist, but a literal "everyone" entry in that list opens it to all — including an unidentified
 * host (empty net id on a listen-server/offline session) — as an opt-in for solo hosts.
 */
